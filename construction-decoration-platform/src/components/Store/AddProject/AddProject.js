...
const AddProject = () => {
  ...
  const { categoryCity, supplier, typeStyle, typeProject } = useSelector((state) => state.projectReducer)


  console.log("typestyle",typeProject)
  ...
  return (
    <div className="store-info">
      <span className="order-title">Thêm Dự Án</span>
      <Form
        layout="horizontal"
